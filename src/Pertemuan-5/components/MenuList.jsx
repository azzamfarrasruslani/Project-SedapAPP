...
export default function MenuList() {
  const listMenu = [
    { id: "menu-1", label: "Dashboard", icon: "home", to: "/" },
    { id: "menu-2", label: "Orders", icon: "newspaper", to: "/orders" },
    { id: "menu-3", label: "Customers", icon: "people", to: "/customers" },
    { id: "menu-4", label: "Error 404", icon: "error", to: "/error/404" },
    { id: "menu-5", label: "Error 403", icon: "error", to: "/error/403" },
    { id: "menu-6", label: "Error 401", icon: "error", to: "/error/401" },
  ];
